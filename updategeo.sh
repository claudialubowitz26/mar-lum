...
wget -O geoip.dat https://github.com/rfxcll/v2ray-rules-dat/releases/download/${latest}/GeoIP.dat
wget -O geosite.dat https://github.com/rfxcll/v2ray-rules-dat/releases/download/${latest}/GeoSite.dat
cd
